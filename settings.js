...
global.owner = process.env.OWNER_NUMBER  || '917067575472' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=6BVAlZqK#SsRJ7-Kr_go2UmVMkT7pypq5rzySYaFTvBxqxicozxI' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,916260273863" : process.env.MODERATORS ,    
